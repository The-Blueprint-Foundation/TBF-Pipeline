...
log = logging.getLogger("ingest_subscriber")
...
def on_message(client, userdata, msg):
    try:
        ...
        record = process(data)
        log.info(f"Storing message from {msg.topic} for {record['device_id']}")
        ...
        log.error(f"Failed to process message on {msg.topic}: {e}")
